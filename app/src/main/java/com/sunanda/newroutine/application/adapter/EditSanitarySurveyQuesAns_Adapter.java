...
public class EditSanitarySurveyQuesAns_Adapter extends RecyclerView.Adapter<EditSanitarySurveyQuesAns_Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        int iId = CGlobal.getInstance().getPersistentPreference(cContext)
