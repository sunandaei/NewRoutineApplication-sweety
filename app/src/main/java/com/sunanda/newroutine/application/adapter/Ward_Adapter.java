...
public class Ward_Adapter extends BaseAdapter {
    Context context;
    ArrayList<CommonModel> cmArrayMaster;
    LayoutInflater inflter;

    public Ward_Adapter(Context applicationContext, ArrayList<CommonModel> cmaMaster) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        item.setText(cmArrayMaster.get(i).getWard_no());
        return view;
    }
}