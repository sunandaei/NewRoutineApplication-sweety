...
public class Zone_Adapter extends BaseAdapter {
    Context context;
    ArrayList<CommonModel> cmArrayMaster;
    LayoutInflater inflter;

    public Zone_Adapter(Context applicationContext, ArrayList<CommonModel> cmaMaster) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        item.setText(cmArrayMaster.get(i).getZone());
        return view;
    }
}