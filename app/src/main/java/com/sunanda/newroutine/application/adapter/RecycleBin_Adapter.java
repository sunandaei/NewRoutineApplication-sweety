...
import com.sunanda.newroutine.application.ui.RecycleBin_Activity;
...
public class RecycleBin_Adapter extends RecyclerView.Adapter<RecycleBin_Adapter.ViewHolder> {
    ...
    private RecycleBin_Activity.BtnRestore btnImage = null;

    public RecycleBin_Adapter(Context context, ArrayList<SampleModel> d, RecycleBin_Activity.BtnRestore listener) {
    ...
    @Override
    public RecycleBin_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycle_bin_item, null);

        RecycleBin_Adapter.ViewHolder viewHolder = new RecycleBin_Adapter.ViewHolder(itemLayoutView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final RecycleBin_Adapter.ViewHolder viewHolder, final int position) {
