...
public class DataUploadSchool_Adapter extends RecyclerView.Adapter<DataUploadSchool_Adapter.ViewHolder> {

    private Context _ctx;
    private ArrayList<SampleModel_School> product_SampleModelsArray;
    private ArrayList<SampleModel_School> sampleModelsArray;
    private DataUploadSchool_Activity.BtnImage btnImage = null;
    private DataUploadSchool_Activity.BtnImageDelete btnImageDelete = null;

    public DataUploadSchool_Adapter(Context context, ArrayList<SampleModel_School> d, DataUploadSchool_Activity.BtnImage listener,
                                    DataUploadSchool_Activity.BtnImageDelete listenerDelete) {
    ...
    @Override
    public DataUploadSchool_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.data_upload_item, null);

        DataUploadSchool_Adapter.ViewHolder viewHolder = new DataUploadSchool_Adapter.ViewHolder(itemLayoutView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final DataUploadSchool_Adapter.ViewHolder viewHolder, final int position) {
