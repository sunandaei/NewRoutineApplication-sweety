...
public class SchoolData_Adapter extends BaseAdapter {
    Context context;
    ArrayList<CommonModel> cmArrayMaster;
    LayoutInflater inflter;

    public SchoolData_Adapter(Context applicationContext, ArrayList<CommonModel> cmaMaster) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        item.setText(cmArrayMaster.get(i).getSchool_name());
        return view;
    }
}