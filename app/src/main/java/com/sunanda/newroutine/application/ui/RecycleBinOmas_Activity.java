...
import com.sunanda.newroutine.application.adapter.RecycleBinOmas_Adapter;
...
public class RecycleBinOmas_Activity extends AppCompatActivity {
    ...
    RecycleBinOmas_Adapter adapter;
    ...
    private void init() {
        ...
        DatabaseHandler databaseHandler = new DatabaseHandler(RecycleBinOmas_Activity.this);
        sampleModelsDataCollection = new ArrayList<>();

        String sFCID = CGlobal.getInstance().getPersistentPreference(RecycleBinOmas_Activity.this)
                .getString(Constants.PREFS_USER_FACILITATOR_ID, "");

        sampleModelsDataCollection = databaseHandler.getRecycleBin(sFCID, "OMAS");

        adapter = new RecycleBinOmas_Adapter(RecycleBinOmas_Activity.this, sampleModelsDataCollection, new BtnRestore() {
            @Override
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(RecycleBinOmas_Activity.this);
        ...
        btnRestore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showData();
                new AlertDialog.Builder(RecycleBinOmas_Activity.this)
