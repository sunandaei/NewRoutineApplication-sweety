...
import com.sunanda.newroutine.application.adapter.RecycleBinSchool_Adapter;
...
public class RecycleBinSchool_Activity extends AppCompatActivity {
    ...
    RecycleBinSchool_Adapter adapter;
    ...
    private void init() {
        ...
        DatabaseHandler databaseHandler = new DatabaseHandler(RecycleBinSchool_Activity.this);
        sampleModelsDataCollection = new ArrayList<>();

        String sFCID = CGlobal.getInstance().getPersistentPreference(RecycleBinSchool_Activity.this)
                .getString(Constants.PREFS_USER_FACILITATOR_ID, "");

        sampleModelsDataCollection = databaseHandler.getRecycleBinSchool(sFCID, "School");

        adapter = new RecycleBinSchool_Adapter(RecycleBinSchool_Activity.this, sampleModelsDataCollection, new BtnRestore() {
            @Override
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(RecycleBinSchool_Activity.this);
        ...
        btnRestore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showData();
                new AlertDialog.Builder(RecycleBinSchool_Activity.this)
