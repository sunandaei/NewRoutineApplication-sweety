...
import com.sunanda.newroutine.application.ui.RecycleBinSchool_Activity;

import java.util.ArrayList;

public class RecycleBinSchool_Adapter extends RecyclerView.Adapter<RecycleBinSchool_Adapter.ViewHolder> {

    private Context _ctx;
    private ArrayList<SampleModel> product_SampleModelsArray;
    private RecycleBinSchool_Activity.BtnRestore btnImage = null;

    public RecycleBinSchool_Adapter(Context context, ArrayList<SampleModel> d, RecycleBinSchool_Activity.BtnRestore listener) {
    ...
    @Override
    public RecycleBinSchool_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycle_bin_item, null);

        RecycleBinSchool_Adapter.ViewHolder viewHolder = new RecycleBinSchool_Adapter.ViewHolder(itemLayoutView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final RecycleBinSchool_Adapter.ViewHolder viewHolder, final int position) {
