...
import com.sunanda.newroutine.application.ui.RecycleBinOmas_Activity;

import java.util.ArrayList;

public class RecycleBinOmas_Adapter extends RecyclerView.Adapter<RecycleBinOmas_Adapter.ViewHolder> {

    private Context _ctx;
    private ArrayList<SampleModel> product_SampleModelsArray;
    private RecycleBinOmas_Activity.BtnRestore btnImage = null;

    public RecycleBinOmas_Adapter(Context context, ArrayList<SampleModel> d, RecycleBinOmas_Activity.BtnRestore listener) {
    ...
    @Override
    public RecycleBinOmas_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycle_bin_item, null);

        RecycleBinOmas_Adapter.ViewHolder viewHolder = new RecycleBinOmas_Adapter.ViewHolder(itemLayoutView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final RecycleBinOmas_Adapter.ViewHolder viewHolder, final int position) {
        ...
        viewHolder.cbRestore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (btnImage != null)
                    btnImage.onBtnRestoreValue((Integer) viewHolder.cbRestore.getTag(), product_SampleModelsArray.get(position).getID(),
                            viewHolder.cbRestore);
            }
        });
    }
